    ...
    public class ExperimentExplorer
    {
        ...
        public bool Connect()
        {
            ...
            else
            {
                ...
                ConnectionStateChanged?.Invoke(result, " " + Reader.HardwareSettings.IP + " " + Reader.HardwareSettings.Port);
            }
        ...
        public event Action SignalReadyEvent;
        public event Action NoiseReadyEvent;
        ...
        //---------------------------------------------------------------------
        public void ShowSignalAndNoise(Interval interval, List<double> sourceSignal, List<double> sourceNoise, Action<double> newSignalShift = null, Action<double> newNoiseShift = null, Action<double> newXShift = null)
        {
